...
public class SearchTrajetServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) 
        ...
        if (villeDepart == null || villeDepart.trim().isEmpty() || 
            ...
            request.setAttribute("error", "Veuillez s�lectionner une ville de d�part, une ville de destination et une date.");
        ...
        try {
            ...
            request.setAttribute("error", "Erreur lors de la recherche. Veuillez r�essayer.");
        }
