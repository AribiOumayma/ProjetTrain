        ...
        <div class="content-container">
            ...
            <div class="page-header">
                <div class="d-flex justify-content-between align-items-center">
                    <h2><i class="bi bi-building me-2"></i>Gestion des gares</h2>
                    <div class="text-end">
            ...
            <div class="form-container">
                <h3>
                    ...
                    <c:choose>
                        <c:when test="${not empty station}">Modifier une gare</c:when>
                ...
                <form action="stations" method="post">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="name" class="form-label">
                                    <i class="bi bi-signpost-2"></i>Nom de la gare
                                </label>
                                <input type="text" id="name" name="name" class="form-control" 
                                       value="${station.name}" required placeholder="Ex: Gare Centrale">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="city" name="city" class="form-control" 
                                       value="${station.city}" required placeholder="Ex: Paris">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="text-end">
                        <button type="submit" class="btn btn-primary">
                            <i class="bi bi-${not empty station ? 'pencil' : 'plus'}-square me-1"></i>
                            <c:choose>
                                <c:when test="${not empty station}">Mettre à jour</c:when>
                                <c:otherwise>Ajouter la gare</c:otherwise>
                            </c:choose>
                        </button>
                    </div>
                </form>
                            ...
                            <tbody>
                                <c:forEach var="station" items="${stations}">
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    ...
                                                    <small class="text-muted">Station ferroviaire</small>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <a href="stations?action=edit&id=${station.id}" class="btn btn-warning btn-sm">
